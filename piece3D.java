...
public class piece3D
{
   ...
   public void normalizePiece( )
   {
      ...
      for ( int whichCube = 0 ; whichCube < nCubes ; whichCube++ )
      {
         ...
         if (cubes[whichCube].x > xMin )  xMax = cubes[whichCube].x ;
         if (cubes[whichCube].y > yMin )  yMax = cubes[whichCube].y ;
         if (cubes[whichCube].z > zMin )  zMax = cubes[whichCube].z ;
      }
   ...
   public void findAllPossiblePositionAsBitmaps( )
   {
      int positionIndex = 0 ;
